...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-900 via-teal-900 to-emerald-900">
          ...
          <div className="space-y-8 text-white">
            ...
            <div className="space-y-4">
              <h1 className="text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight">
                ...
                <br />
                <span className="bg-gradient-to-r from-emerald-200 via-teal-200 to-cyan-200 bg-clip-text text-transparent flex items-center gap-4">
                  The Holy Quran
                  <span className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-yellow-400 to-amber-500 rounded-2xl shadow-2xl transform hover:rotate-12 transition-transform duration-300">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button className="group relative bg-gradient-to-r from-teal-500 to-emerald-500 hover:from-teal-600 hover:to-emerald-600 text-white px-10 py-7 text-lg rounded-2xl font-bold shadow-2xl hover:shadow-teal-500/50 transition-all duration-300 border-2 border-white/20 overflow-hidden">
          ...
          <div className="relative h-[600px] lg:h-[700px]">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="relative w-full max-w-md">
                {/* Glowing Effect */}
                <div className="absolute inset-0 bg-gradient-to-r from-teal-400 to-emerald-400 rounded-3xl blur-3xl opacity-30 animate-pulse"></div>

                {/* Main Card */}
                <div className="relative bg-gradient-to-br from-white/95 to-white/90 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/50 transform hover:scale-105 transition-all duration-500">
                  {/* Islamic Pattern Header */}
                  <div className="flex items-center justify-center mb-8">
                    <div className="relative">
                      <div className="absolute inset-0 bg-gradient-to-br from-teal-400 to-emerald-500 rounded-2xl blur-xl opacity-60"></div>
                      <div className="relative bg-gradient-to-br from-teal-600 to-emerald-600 rounded-2xl p-8 shadow-2xl">
                  ...
                  <div className="space-y-6 mb-8">
                    ...
                    {/* Quran Pages Mockup */}
                    <div className="bg-gradient-to-br from-slate-50 to-teal-50 rounded-2xl p-6 shadow-inner">
                      <div className="space-y-3">
                        <div className="flex items-center gap-2 mb-4">
                          <div className="w-8 h-8 rounded-full bg-gradient-to-br from-teal-500 to-emerald-500 flex items-center justify-center text-white text-sm font-bold shadow-lg">
                            1
                          </div>
                        ...
                        {[...Array(6)].map((_, i) => (
                          <div
                            key={i}
                            className="h-2 bg-gradient-to-r from-slate-300 to-slate-200 rounded-full animate-pulse"
                            style={{
                      ...
                      (feature, idx) => (
                        <Badge
                          ...
                          className={`px-4 py-2 rounded-full font-semibold shadow-lg transition-all duration-300 ${
                            activeCard === idx % 3
                              ? "bg-gradient-to-r from-teal-500 to-emerald-500 text-white scale-110"
                ...
                <div className="absolute -bottom-8 -right-8 bg-white/90 backdrop-blur-md rounded-2xl p-4 shadow-2xl border border-white/50 transform hover:scale-110 transition-all duration-300 animate-float-delayed">
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500 to-cyan-500 flex items-center justify-center text-white text-xl shadow-lg">
                      🌍
                    </div>
                    <div>
                      <p className="text-xs text-gray-500 font-medium">
                ...
                <div className="absolute top-1/2 -right-12 bg-white/90 backdrop-blur-md rounded-2xl p-4 shadow-2xl border border-white/50 transform hover:scale-110 transition-all duration-300 animate-float-slow">
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-orange-500 to-red-500 flex items-center justify-center text-white text-xl shadow-lg">
                      📖
                    </div>
                    <div>
                      <p className="text-xs text-gray-500 font-medium">

...
const NewsletterSection = () => {
  ...
  return (
    <div className="py-20 bg-gradient-to-br from-emerald-600 to-teal-700 relative overflow-hidden">
      {/* Background Pattern */}
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute bottom-20 left-1/4 w-40 h-40 bg-white/5 rounded-full"></div>
        <div className="absolute bottom-10 right-10 w-20 h-20 bg-white/15 rounded-full"></div>
      </div>
          ...
          <div className="space-y-6">
            {newsletterFeatures.map((feature, index) => (
              <div key={index} className="flex items-start space-x-4 group">
                <div className="flex-shrink-0 w-12 h-12 bg-white/10 backdrop-blur-sm rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 border border-white/20">
                  ...
                  <div className="space-y-4">
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-4 py-4 bg-white/90 border border-white/30 rounded-2xl focus:outline-none focus:ring-2 focus:ring-amber-400 focus:border-transparent text-slate-800 placeholder-slate-500"
                      />
                    </div>

                    <Button
                      onClick={handleSubscribe}
                      className="w-full bg-amber-400 hover:bg-amber-500 text-slate-800 font-bold py-4 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
                    >

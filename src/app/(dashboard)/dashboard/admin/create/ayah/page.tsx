...
const CreateAyahPage = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.surahNumber || formData.surahNumber < 1 || formData.surahNumber > 114) {
    ...
    if (!formData.ayahNumber || formData.ayahNumber < 1) {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6 mb-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-bold text-gray-900">Create New Ayah</h1>
          </div>
          <p className="text-gray-600">Add a new Quranic verse to the database with complete details and references.</p>
        </div>
        ...
        {submitSuccess && (
          <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6 flex items-center gap-2">
            ...
            <span className="text-green-800 font-medium">Ayah created successfully!</span>
          </div>
        )}
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <textarea
                    ...
                    style={{ fontFamily: 'Arial, sans-serif', fontSize: '18px', lineHeight: '1.8' }}
                  />
                  {errors.arabicText && (
                    <p className="text-red-500 text-sm mt-1 flex items-center gap-1">
                      <AlertCircle className="h-4 w-4" />
            ...
            {(formData.arabicText || formData.translation) && (
              <div className="mb-8">
                ...
                <div className="bg-gradient-to-r from-emerald-50 to-teal-50 rounded-lg p-6 border border-emerald-200">
                  ...
                  {formData.arabicText && (
                    <div className="text-right mb-4 text-xl leading-relaxed" style={{ fontFamily: 'Arial, sans-serif' }}>
                      {formData.arabicText}
                    </div>
                  )}
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mt-6">
          <h4 className="font-semibold text-blue-900 mb-3">Guidelines for Adding Ayahs</h4>
